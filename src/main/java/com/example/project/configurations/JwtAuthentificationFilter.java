...
//we want this filter to be active every time the user sends a request so we extends OncePerRequestFilter
@Component // we want to tell spring that this is a bean
